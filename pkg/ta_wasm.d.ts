...
export function chirp_correction_global(time: Float64Array, wl: Float64Array, ta: Float64Array, n_wl: number, n_time: number): any;

export function chirp_correction_half_height(time: Float64Array, wl: Float64Array, ta: Float64Array, n_wl: number, n_time: number): any;
...
export interface InitOutput {
    ...
    readonly chirp_correction_global: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => any;
    readonly chirp_correction_half_height: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => any;
